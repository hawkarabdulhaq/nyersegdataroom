...
st.sidebar.write("Navigate through the stages below:")
st.sidebar.write("1. Home")
st.sidebar.write("2. Shape Cleaning")
st.sidebar.write("3. Generate Wells")
st.sidebar.write("4. Clean Wells")
st.sidebar.write("5. Download")
